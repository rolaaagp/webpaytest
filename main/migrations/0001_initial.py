# Generated by Django 4.2.11 on 2024-05-01 23:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comuna', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.comuna')),
                ('estado', models.ForeignKey(default=3, on_delete=django.db.models.deletion.DO_NOTHING, to='main.estado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comuna', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.comuna')),
                ('estado', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.estado')),
                ('genero', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.genero')),
                ('pais', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.pais')),
                ('perfiles', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.perfiles')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.producto')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.productocategoria'),
        ),
        migrations.AddField(
            model_name='producto',
            name='proveedor',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.proveedor'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orden_de_compra', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.ordendecompra')),
                ('producto', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.producto')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='users_metadata',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.usersmetadata'),
        ),
        migrations.AddField(
            model_name='comuna',
            name='region',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.region'),
        ),
        migrations.CreateModel(
            name='Carrito',
            fields=[
                ...
                ('fecha', models.DateField(auto_now=True, null=True)),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.producto')),
                ('users_metadata', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.usersmetadata')),
            ],
            options={
